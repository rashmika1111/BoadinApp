// screens/CustomerHouse.js
import React, { useState } from 'react';
import { View, Text, StyleSheet, FlatList, Image, TouchableOpacity, Modal } from 'react-native';

const CustomerHouse = ({ route }) => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>House Listings</Text>
      <FlatList
        data={filteredData}
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            <FlatList
              ...
              renderItem={({ item }) => (
                <Image source={item} style={styles.image} /> // Updated: Directly use `item` as the source
              )}
            />
            <TouchableOpacity
